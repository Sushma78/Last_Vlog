                    ...
                    <div class="blog-content">
                        <div class="post-content mt-1">
                            ...
                            <div class="d-flex justify-content-between mb-15">
                                ...
                                <?php $videoPlayer = new VideoInfoSection($con, $video, $userLoggedInObj);
                            ...
                            <div class="vizew-post-author d-flex align-items-center py-2">
                                ...
                                <?php $videoPlayer = new VideoInfoSection($con, $video, $userLoggedInObj);
                                echo $videoPlayer->createSecondary(); ?>

                                <?php $videoPlayer = new VideoInfoSection($con, $video, $userLoggedInObj);
                                echo $videoPlayer->createThird(); ?>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="sidebar-area">
                    ...
                    <div class="single-widget add-widget mb-20">
                        <img src="img/logo.png" alt="" style="background:beige
                        ;">
                    </div>
